...
object FieldPositions {
    ...
    val trenchInside = listOf(
        ...
        FieldLocation(Pose3d(467.64, 292.31, 35.0, 180.rotation3dFromDeg()), Pose3d(183.59, 292.31, 35.0, 0.rotation3dFromDeg())),        /** coordinates for AprilTag 6 and AprilTag 17 */
        FieldLocation(Pose3d(467.64, 25.37, 35.00, 180.rotation3dFromDeg()),Pose3d(183.59, 25.37, 35.00, 0.rotation3dFromDeg()))
    )
    /** Trench facing the OUTSIDE of the arena */
    val trenchOutside = listOf(
        /** coordinates for AprilTag 12 and AprilTag 17 */
        FieldLocation(Pose3d(470.59, 292.31, 35.00, 0.rotation3dFromDeg()), Pose3d(183.59, 25.37, 35.00, 0.rotation3dFromDeg())),
        /** coordinates for AprilTag 7 and AprilTag 28 */
        FieldLocation(Pose3d(470.59, 25.37, 35.00, 0.rotation3dFromDeg()), Pose3d(180.64, 25.37, 35.00, 180.rotation3dFromDeg()))
    )

    /** Tower */
    val tower = listOf(
        /** coordinates for AprilTag 16 and AprilTag 31 */
        FieldLocation(Pose3d(650.90, 153.22, 21.75, 180.rotation3dFromDeg()), Pose3d(0.32, 147.47, 21.75, 0.rotation3dFromDeg())),
        /** coordinates for AprilTag 15 and AprilTag 32 */
        FieldLocation(Pose3d(650.90, 170.22, 21.75, 180.rotation3dFromDeg()), Pose3d(0.32, 164.47, 21.75, 0.rotation3dFromDeg()))
    )

    /** Outpost */
    val outpost = listOf(
        /** coordinates for AprilTag 13 and AprilTag 30 */
        FieldLocation(Pose3d(650.92, 291.47, 21.75, 180.rotation3dFromDeg()), Pose3d(0.30, 43.22, 21.75, 0.rotation3dFromDeg())),
        /** coordinates for AprilTag 14 and AprilTag 29 */
        FieldLocation(Pose3d(650.92, 274.47, 21.75, 180.rotation3dFromDeg()), Pose3d(0.30, 26.22, 21.75, 0.rotation3dFromDeg()))
    )
